...
func BenchmarkEncodeHashChain1(b *testing.B) {
	benchmark(b, "../testdata/Isaac.Newton-Opticks.txt", &pack.HashChain{SearchLen: 1, MaxDistance: 1 << 20, Parser: &pack.OverlapParser{Score: Score}}, 1<<16)
}

func BenchmarkEncodeHashChain10(b *testing.B) {
	benchmark(b, "../testdata/Isaac.Newton-Opticks.txt", &pack.HashChain{SearchLen: 10, MaxDistance: 1 << 20, Parser: &pack.OverlapParser{Score: Score}}, 1<<16)
}

func BenchmarkEncodeHashChain100(b *testing.B) {
	benchmark(b, "../testdata/Isaac.Newton-Opticks.txt", &pack.HashChain{SearchLen: 100, MaxDistance: 1 << 20, Parser: &pack.OverlapParser{Score: Score}}, 1<<16)
}
